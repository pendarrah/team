        ...
        <div class="row">
            <div class="col-md-8 col-lg-8">
                <div class="custom-top-title-box">
                    ...
                    <a href="#downloads" class="btn custom-btn-style-1 text-color-light mb-5" data-hash>همین الان شروع کنید</a>
                    ...
                    <span class="d-flex align-items-center w-100">
										...
										<img src="img/demos/app-landing/logos/logo-1.png" style="max-width: 120px;" alt class="img-fluid" />
										<img src="img/demos/app-landing/logos/logo-2.png" style="max-width: 120px;" alt class="img-fluid" />
									</span>
                </div>
            </div>
...
<div class="container marginBottomTeamofit" >
    ...
    <div class="events_filter_show_nav">
        <div class="select_cat_mobile_btn">
            <ul class="clearfix ovaem_events_filter_nav style3 teamofitFilter">
                <li class="all current"><a href="#" class="ova-btn ova-btn-rad-30">همه</a></li>
                <li class="conference"><a class="ova-btn ova-btn-rad-30" href="#">فوتبال</a></li>
                <li class="travel"><a class="ova-btn ova-btn-rad-30" href="#">والیبال</a></li>
                <li class="business"><a class="ova-btn ova-btn-rad-30" href="#">بسکتبال</a></li>
                <li class="concert"><a class="ova-btn ova-btn-rad-30" href="#">فوتسال</a></li>
                <li class="festival"><a class="ova-btn ova-btn-rad-30" href="#">شنا</a></li>
            </ul>
        </div>
    </div>
    <div class="row ovaem_events_filter_content">

        @foreach ($events as $event)
            <div class="col-md-4 col-sm-6 col-xs-6 ova-item isotope-item style3  conference">
                <a href="#">
