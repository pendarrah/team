...
var KTLoginGeneral = function() {
    var t = $("#kt_login"),
        i = function(t, i, e) {var n = $('<div class="kt-alert kt-alert--outline alert alert-' + i + ' alert-dismissible" role="alert">\t\t\t<button type="button" class="close" data-dismiss="alert" aria-label="Close"></button>\t\t\t<span></span>\t\t</div>');t.find(".alert").remove(), n.prependTo(t), KTUtil.animateClass(n[0], "fadeIn animated"), n.find("span").html(e)},
        e = function() {
        ...
        n = function() {
            $("#kt_login_forgot").click(function(i) {
                ...
                t.preventDefault(), e()
            }), $("#showSignUp").click(function(i) {
               t.removeClass("kt-login--forgot"), t.removeClass("kt-login--signin"), t.addClass("kt-login--signup"), KTUtil.animateClass(t.find(".kt-login__signup")[0], "flipInX animated")
            }), $("#showSignUp_cancel").click(function(t) {
                t.preventDefault(), e()
            })
        };
    return {
            ...
            n(), $("#kt_login_signin_submit").click(function(t) {
                ...
                n.validate({
                    ...
                    success: function(t, s, r, a) {
                        setTimeout(function() {
                            e.removeClass("kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light").attr("disabled", !1), i(n, "danger", "Incorrect username or password. Please try again.")
                        }, 2e3)
                    }
                }))
            }), $("#showSignkUp_submit").click(function(n) {
                n.preventDefault();
                var s = $(this),
                    r = $(this).closest("form");
                r.validate({
